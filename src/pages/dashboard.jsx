...
import NavbarMobile from "../components/Navbar.Mobile";
 ...
 function Dashboard() {
  return (
    <>
    <div className=" font-sans bg-gray-50 dark:bg-zinc-950 text-gray-900 dark:text-gray-100 md:px-28 2xl:px-72 px-4">
  <div className="flex min-h-screen">
    ...
    <main className="flex-grow p-4 lg:p-8 bg-gray-50 dark:bg-zinc-950">
      ...
      <section>
        <h2 className="text-xl font-semibold mb-1 divide-y-4 ">Center Information</h2>
        <div className="p-4"></div>
        
        <div className="bg-white dark:bg-zinc-950 py-3">
          <ul>
